...
namespace Miscelanea
{
    internal class menus
    {
        ...
        public static void MenuOperadores()
        {
            ...
            Console.WriteLine("\n7. Radio, Longitud y Area de un circunferencia. ");
        ...
        public static void Volver()
        {
            ...
            RespuestaContinuar = Console.ReadLine();
                if ((RespuestaContinuar == "SI") || (RespuestaContinuar ==
               "si"))
                {
                    Console.Clear();
                    MetodoMain.Main();
                }
                else if ((RespuestaContinuar == "NO") || (RespuestaContinuar ==
               "no"))
                {
                    Console.Clear();
            ...
            } while ((RespuestaContinuar != "SI") && (RespuestaContinuar !=
           "NO"));
        }
    }
}